...
let rec string_of_exp e = 
	...
	| FMul (e1,e2) -> "("^(string_of_exp e1)^")*.("^(string_of_exp e2)^")" 
	| FAdd (e1,e2) -> "("^(string_of_exp e1)^")+.("^(string_of_exp e2)^")"
	| FSub (e1,e2) -> "("^(string_of_exp e1)^")-.("^(string_of_exp e2)^")"
	| FDiv (e1,e2) -> "("^(string_of_exp e1)^")/.("^(string_of_exp e2)^")"
	...
	| Lam (x,e) -> "/"^x^"."^string_of_exp e
	| RLam (x,f,e) -> "/("^f^","^x^")."^"("^string_of_exp e^")"
